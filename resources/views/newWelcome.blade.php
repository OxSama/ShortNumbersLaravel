        ...
        <nav class="navbar navbar-light">
            <div class="navbar-left">
                ...
                <a class="navbar-brand" href="#">
                    <img class="svg dark" src="index.png" alt="svg"><img class="light" src="index.png" alt="img"></a>
                <div class="top-menu">
                ...
                <ul class="sidebar_nav">
                    ...
                    <li class="has-child">
                        <a href="#" class="">
                            ...
                            <span class="menu-text">Dashboard Content</span>
                        ...
                        <ul>
                            <li class="has-child">
                                ...
                                <ul style="display: none;">
                                            <li class="">
                                                <a href=price.html class="">Change price

                                                </a>
                                            </li>

                                            <li class="">
                                                <a href=range.html class="">Change range </a>
                                            </li>
                            ...
                            <li>
                                <a class="" href="#">View Coustmers Requests</a>
                            </li>
                            ...
                            <li class="has-child">
                                ...
                                <ul style="display: none;">
                                    <li class="has-child">
                                        <a href="feather.html" class="">dayliy reports
                                            <span class="toggle-icon"></span>
                                    ...
                                    <li class="has-child">
                                        ...
                                        <ul style="display: none;">
                                            <li class="">
                                                <a href=report.html class="">allocated number
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <select class="form-control" name="" id="">
                                                    ...
                                                    <option value="">by categorise</option>
                                                    ...
                                                    <table class="table mb-0">
                                                        <thead class="">
                                                            ...
                                                            <tr class="userDatatable-header">
                                                                ...
                                                                <th class="projectDatatable-title">short number</th>

                                                                <th class="projectDatatable-title">
                                                                    company name </th>
                                                                <th class="projectDatatable-title">service provider

                                                                </th>
                                                                <th class="projectDatatable-title">type of service</th>
                                                                <th class="projectDatatable-title">company catogrie
                                                                </th>
                                                                <th class="projectDatatable-title">others
                                                                </th>
                                                            </tr>


                                                            <!---
                                                                <th class="projectDatatable-title">ID</th>
                                                                <th class="projectDatatable-title">Classfcation
                                                                </th>
                                                                <th class="projectDatatable-title">Service sutus</th>
                                                                <th class="projectDatatable-title">Service type</th>
                                                                <th class="projectDatatable-title">Provider </th>
                                                                <th class="projectDatatable-title">Company Name
                                                                </th>
                                                                <th class="projectDatatable-title">Short number
                                                                </th>
                                                                <th class="projectDatatable-title">Display </th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td>2</td>
                                                                <td>Service classfcation</td>
                                                                <td>enabled</td>
                                                                <td>SMS</td>
                                                                <td>Zain</td>
                                                                <td>Thires ganration telcommenction company</td>
                                                                <td>6359</td>
                                                                <td>dispaly</td>
